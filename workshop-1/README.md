...
| ------------ | ------------- | 
**Stockholm** (eu-north-1) | [![Launch Mythical Mysfits Stack into Singapore with CloudFormation](/images/deploy-to-aws.png)](https://console.aws.amazon.com/cloudformation/home?region=eu-north-1#/stacks/new?stackName=mysfits-fargate&templateURL=https://raw.githubusercontent.com/eriweb/amazon-ecs-mythicalmysfits-workshop/master/workshop-1/core.yml)
